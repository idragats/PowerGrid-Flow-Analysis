...
nodes100=readtable('grid-nodes-R-99.dat');


nodes=100;
avnodedegree=[10;20;30;40;50;60;70;80;90;99];

[power_supply_level_10,power_demand_level_10,current_time_10]=Power(nodes10.Var5,nodes10.Var6,nodes10.Var2,nodes);
[power_supply_level_20,power_demand_level_20,current_time_20]=Power(nodes20.Var5,nodes20.Var6,nodes20.Var2,nodes);
[power_supply_level_30,power_demand_level_30,current_time_30]=Power(nodes30.Var5,nodes30.Var6,nodes30.Var2,nodes);
[power_supply_level_40,power_demand_level_40,current_time_40]=Power(nodes40.Var5,nodes40.Var6,nodes40.Var2,nodes);
[power_supply_level_50,power_demand_level_50,current_time_50]=Power(nodes50.Var5,nodes50.Var6,nodes50.Var2,nodes);
[power_supply_level_60,power_demand_level_60,current_time_60]=Power(nodes60.Var5,nodes60.Var6,nodes60.Var2,nodes);
[power_supply_level_70,power_demand_level_70,current_time_70]=Power(nodes70.Var5,nodes70.Var6,nodes70.Var2,nodes);
[power_supply_level_80,power_demand_level_80,current_time_80]=Power(nodes80.Var5,nodes80.Var6,nodes80.Var2,nodes);
[power_supply_level_90,power_demand_level_90,current_time_90]=Power(nodes90.Var5,nodes90.Var6,nodes90.Var2,nodes);
[power_supply_level_100,power_demand_level_100,current_time_100]=Power(nodes100.Var5,nodes100.Var6,nodes100.Var2,nodes);
...
title("Power Supply flow total-power-flux=100")
xlabel("Current Time")
ylabel("% Power Supply")
legend({'10 average node degree','20 average node degree','30 average node degree','40 average node degree','50 average node degree','60 average node degree','70 average node degree','80 average node degree','90 average node degree','99 average node degree'})



current_time=[current_time_10(end); current_time_20(end);current_time_30(end); current_time_40(end); ...
              current_time_50(end);current_time_60(end); current_time_70(end); current_time_80(end); ...
              current_time_90(end); current_time_100(end)];
...
power_variance=[sqrt(sum(nodes10.Var5-nodes10.Var6)^2); sqrt(sum(nodes20.Var5-nodes20.Var6)^2); ...
             ...
             figure(2)
 plot(avnodedegree,current_time,'.-')
...
edges100=readtable('grid-edges-R-99.dat');
...
load=[mean(edges10.Var5) ; mean(edges20.Var5); mean(edges30.Var5);mean(edges40.Var5); ...
 ...
 figure(4)
 plot(avnodedegree,flux_variance,'*-')
xlabel("average-node-degree")
 ylabel("flux variance")


fileID1 = fopen('current_time100.txt','w');
 fileID2 = fopen('load100.txt','w');
 fileID3 = fopen('flux_variance100.txt','w');
